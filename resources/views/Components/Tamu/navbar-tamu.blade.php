<div class="w-full h-16 xl:h-20 2xl:h-24 bg-white shadow-md text-black flex justify-between px-14 items-center">
    <a class="hover:text-[#e3b04b] font-bold hover:scale-110 duration-150 text-lg 2xl:text-xl" href="/">ATHAR RAYYAN M</a>
    <ul class=" list-none flex gap-10 items-center">
        ...
        <li class="hover:scale-[1.03] duration-150">
            <a class=" font-semibold text-white" href="/admin">
                <button class="hover:bg-[#C99B3D] bg-[#e3b04b] flex justify-center gap-2 px-3 xl:px-[1.5rem] py-1.5 2xl:px-[1.8rem] xl:py-2 2xl:py-3 rounded-md items-center text-sm xl:text-base 2xl:text-xl">
                    Admin
